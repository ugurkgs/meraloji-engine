...
function getWeatherIconicDescription(code, lang, rain = 0, wind = 0) {
    const weatherMap = {
        ...
        56: { tr: "🧊 Hafif Dondurucu Çiseleme", en: "🧊 Light Freezing Drizzle", es: "🧊 Llovizna helada ligera", el: "🧊 Ασθενές παγωμένο ψιχάλισμα" },
        57: { tr: "🧊 Şiddetli Dondurucu Çiseleme", en: "🧊 Dense Freezing Drizzle", es: "🧊 Llovizna helada intensa", el: "🧊 Πυκνό παγωμένο ψιχάλισμα" },
        ...
        66: { tr: "🧊 Hafif Dondurucu Yağmur", en: "🧊 Light Freezing Rain", es: "🧊 Lluvia helada ligera", el: "🧊 Ασθενής παγωμένη βροχή" },
        67: { tr: "🧊 Şiddetli Dondurucu Yağmur", en: "🧊 Heavy Freezing Rain", es: "🧊 Lluvia helada fuerte", el: "🧊 Ισχυρή παγωμένη βροχή" },
        ...
        77: { tr: "🌨️ Kar Tanecikleri", en: "🌨️ Snow Grains", es: "🌨️ Granos de nieve", el: "🌨️ Κόκκοι χιονιού" },
        ...
        85: { tr: "🌨️ Hafif Kar Sağanağı", en: "🌨️ Slight Snow Showers", es: "🌨️ Chubascos de nieve ligeros", el: "🌨️ Ασθενείς μπόρες χιονιού" },
        86: { tr: "🌨️ Şiddetli Kar Sağanağı", en: "🌨️ Heavy Snow Showers", es: "🌨️ Chubascos de nieve fuertes", el: "🌨️ Ισχυρές μπόρες χιονιού" },
...
//
// VARSAM (Echiichthys vipera) KAPSAM DIŞI — sahibin kararı, 2026-08-31:
// "varsam ekleme, türkiyede bilinen balık değil." Kaynak kitap onu "ailenin en
// kuvvetli zehirlisi" diye işaretliyor ama species.js'e girmeyecek. Bu uyarı
// yalnız trakonya üzerinden çalışır. YENİDEN AÇMA.
...
function calculateFishScore(fish, key, params, lang = 'tr') {
    ...
    //
    // [2026-09-24] KAYALIK TÜRÜ KUM/ÇAMURDA ×0,70. KAYALIK kategorisinin 7
    // türünün (kikla, sarpa, muren, gelincik, cutre, lapin, horozbina) HİÇBİRİ
    // SUBSTRATE_PREFS'te yoktu → dip ne derse desin ×1,0. Sahip Selçuk'ta
    // (37.9745,27.2517, geniş kumluk) horozbina 69'u ilk sırada gördü: "taşların
    // arasında yaşar". Ölçüldü (tools/motor.js, Ege türleri): kumsal senaryosunda
    // horozbina 5. → 23.; kayalık senaryosunda sıralama DEĞİŞMEDİ.
